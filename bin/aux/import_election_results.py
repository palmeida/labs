...
party_info = {
    ...
    'BE': { 'name': 'Bloco de Esquerda', 'wikipedia': 'Bloco_de_Esquerda_(Portugal)', 'tendency': 'Esquerda', 'order': 20, 'color_1': 'black', 'color_2': 'red' },
    ...
    'PCTP/MRPP': { 'name': 'Partido Comunista dos Trabalhadores Portugueses', 'wikipedia': 'Partido_Comunista_dos_Trabalhadores_Portugueses', 'tendency': 'Esquerda', 'order': 200, 'color_1': 'crimson', 'color_2': 'black' },
    ...
    'UDP/PSR': { 'name': 'Coligação UDP/PSR', 'wikipedia': '', 'tendency': 'Esquerda', 'order': 290, 'color_1': 'Cyan', 'color_2': 'red' },
...
with transaction.commit_on_success():
    for row in data:
        ...
        election_date  = datetime.datetime.strptime(row[3], '%d/%m/%Y').date()
